...
import 'package:pr_2/common/databaserequest.dart';
import 'package:path/path.dart';
import 'package:pr_2/models/role.dart';
import 'package:pr_2/models/typeFurniture.dart';
...
class DataBaseHelper {
  ...
  Future<void> init() async {
    ...
    _pathDB = join(_appDocumentDirectory.path, 'HOFF_Shop.db');
  ...
  Future<void> onInitTable(Database db) async {
    try {
      db.insert(DataBaseRequest.tableRole,
          Role(id: 1, role: 'Администратор').toMap());
      db.insert(
          DataBaseRequest.tableRole, Role(id: 2, role: 'Пользователя').toMap());
      db.insert(DataBaseRequest.tableTypeFurniture,
          TypeFurniture(id: 1, name: 'Стол').toMap());
      db.insert(DataBaseRequest.tableTypeFurniture,
          TypeFurniture(id: 2, name: 'Стул').toMap());
      db.insert(DataBaseRequest.tableTypeFurniture,
          TypeFurniture(id: 3, name: 'Диван').toMap());
